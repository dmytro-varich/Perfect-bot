...
<b>щоденну кількість калорій</b>, яка буде дорівнювати — <code>{target_calories} г на день.</code> 📈"""
...
🍽 <b>Калорії:</b> <code>{target_calories} г на день.</code>
...
🔹 <b>{days_translation_day}</b> ({weekly_data_date})
  🍽️ <i>Спожито:</i>
<code>  🔸 Калорії:   {weekly_data_consumed_calories} ккал
  🔸 Протеїн:   {weekly_data_consumed_protein} г
  🔸 Жири:      {weekly_data_consumed_fat} г
  🔸 Вуглеводи: {weekly_data_consumed_carbohydrate} г</code>\n\n"""
